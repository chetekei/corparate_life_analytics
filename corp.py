...
if uploaded_file is not None:
    if chart_select == "January 2023":
        ...
        # Select desired columns
        Jun = Jun.loc[:, ['Policy No', 'Insured', 'Status','Start Date', 'Maturity Date', 'Sum Insured', 'Annual Premium', 'Premium Received', 'Months(inception to maturity)', 'Premium Outstanding']]
